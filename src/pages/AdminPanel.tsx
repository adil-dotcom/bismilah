...
import { Plus, UserPlus, Search, Lock, Shield, AlertTriangle, Download, Upload, RefreshCw } from 'lucide-react';
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Êtes-vous sûr de vouloir réinitialiser toutes les informations ? Cette action est irréversible.
            </p>
